...
return [
    'label' => [
        ...
        'assign_role_to_user' => 'Assign <b>:role</b> role to <b>:user</b>',
        'assign_permission_to_user' => 'Assign permissions to <b>:user</b>',
        ...
        'delete_data_description' => 'This action will permanently delete the selected data.',
        'delete_account' => 'Delete Account',
        'delete_account_description' => 'Permanently delete your account.',
        'delete_account_confirm' => 'Are you sure you want to delete your account?',
        'delete_account_content' => 'Once your account is deleted, all of its resources and data will be permanently deleted. Please download any data or information that you wish to retain.',
        'please_enter_password_before_delete' => 'Please enter your password to confirm you would like to permanently delete your account.',
        ...
        'permissions_description' => 'Permissions are used to grant users access the system, grouped by module name.',
        'role' => 'Role',
        'roles' => 'Roles',
        'roles_description' => 'Roles are collection set of permissions that assigned to users within their level.',
        'no_user_was_chosen' => 'No user was chosen!',
        'user' => 'User',
        'users' => 'Users',
        ...
        'warning' => 'Warning',
        'please_proceed_with_caution_this_cannot_be_undone' => 'Please proceed with caution, this action cannot be undone.',
        'appearance' => 'Appearance',
        'update_your_accounts_appearance_settings' => 'Update your account\'s appearance settings',
        'theme' => 'Theme',
        'select_the_theme_for_the_app' => 'Select the theme for the app.',
        'language' => 'Language',
        'select_the_language_support' => 'Select the language support.',
        'light' => 'Light',
        'dark' => 'Dark',
        'system' => 'System',
        'create_manage_user_accounts_within_the_system' => 'Create & manage user accounts within the system.',
        'add_new_user' => 'Add New User',
        'create_new_user_here_click_save_when_youre_done' => 'Create new user here. Click save when you\'re done.',
        'active' => 'Active',
        ...
        'enter_your_email_and_password_below_to_start_session' => 'Enter your email and password below to start session',
